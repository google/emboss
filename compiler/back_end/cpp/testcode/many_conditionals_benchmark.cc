...
// Since this file is in compiler/back_end/cpp/testcode/, it will be built as a cc_test.
// We can use GoogleTest macros.
...
TEST(ComplexConditionals, PerformanceBenchmark) {
  ...
  std::cout << "Time for " << iterations << " iterations (x100 tags): " << elapsed.count() << "s" << std::endl;
