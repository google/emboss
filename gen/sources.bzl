...
EMBOSSC_SOURCES = [
    ...
    "compiler/back_end/cpp/clang_format_path.py",
    ...
    "compiler/back_end/reflection/__init__.py",
    "compiler/back_end/reflection/emboss_codegen_reflection.py",
    "compiler/back_end/reflection/reflection_generator.py",
    ...
    "compiler/util/expression_printer.py",
