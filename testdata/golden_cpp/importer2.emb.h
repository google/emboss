...
class GenericOuter2View final {
 ...
 public:
  [[nodiscard]] typename ::emboss::test::GenericOuterView<typename Storage::template OffsetStorageType</**/0, 0>>

 outer() const;
  [[nodiscard]] ::emboss::support::Maybe<bool> has_outer() const;
...
template <typename T>
[[nodiscard]] inline GenericOuter2View<
...
template <typename T>
[[nodiscard]] inline GenericOuter2View</**/ ::emboss::support::ContiguousBuffer<T, 1, 0>>
